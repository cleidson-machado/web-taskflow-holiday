...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    { name: 'Board', icon: LayoutDashboard, href: '/board' },
    { name: 'Minhas Tarefas', icon: ListChecks, href: '/tasks' },
    ...
    <div className="min-h-screen"> 
      ...
      <header className="fixed top-0 left-0 w-full h-16 bg-gray-800 z-50 shadow-xl flex items-center px-6 text-white">
        ...
        <div className="ml-auto flex items-center space-x-4">
          <span className="text-sm text-gray-400 hidden sm:inline">Usuário: Admin</span>
